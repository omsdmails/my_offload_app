...
our %config = (
  ...
  CFLAGS => [ "-target armv7a-linux-androideabi23 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  CPPDEFINES => [ "__ANDROID_API__=23" ],
  CPPFLAGS => [ "-DANDROID -I/home/osama/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/osama/my_offload_app/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/offloadapp/armeabi-v7a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/osama/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target armv7a-linux-androideabi23 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CXXFLAGS => [ "-target armv7a-linux-androideabi23 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)armv7a-linux-androideabi23-clang",
  minor => "1.1",
  ...
  perlenv => {
      ...
      "PERL" => undef,
      "RANLIB" => "/home/osama/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib",
      "RC" => undef,
      "RCFLAGS" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => undef,
